...
/**
 * BushTileRight class (implement Tile)
 * Right part of the bush
 */
class BushTileRight(
    x: Int = 0,
    y: Int = 0
    ...
    override suspend fun initInContainer(container: Container) {
        ...
        // Set the sprite
        playAnimationLooped(
            SpriteUtil.initSprite("scaledSprites/environment/tiles/bush/bush-right.png", 1, 1, false)
        )
    }
}

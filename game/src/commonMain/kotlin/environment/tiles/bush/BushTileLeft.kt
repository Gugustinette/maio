...
/**
 * BushTileLeft class (implement Tile)
 * Left part of the bush
 */
class BushTileLeft(
    x: Int = 0,
    y: Int = 0
    ...
    override suspend fun initInContainer(container: Container) {
        ...
        // Set the sprite
        playAnimationLooped(
            SpriteUtil.initSprite("scaledSprites/environment/tiles/bush/bush-left.png", 1, 1, false)
        )
    }
}
